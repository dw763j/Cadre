...
# Notes
# - Cluster files: results/failed_job_clusters/<repo>#<name>#clusters.json
...
# - Tool run logs: several directories containing run_logs/*.json with entries of builds having full_build_tag
...
SELECTED_TOOLS = [
    'one_dir_one_file_DeepSeek-V3', 
    'parfum', 
    # 'one_dir_one_file_gpt_5', 
    'pure_llm_DeepSeek-V3', 
    'flakidock_gpt_4_sv11',
    'flakidock_upgrade_response_deal_DeepSeek-V3'
]
LABEL_MAP = {
    'one_dir_one_file_DeepSeek-V3': 'Cadre',
    'parfum': 'Parfum',
    'one_dir_one_file_gpt_5': 'Cadre-GPT-5',
    'pure_llm_DeepSeek-V3': 'Vanilla-LLM',
    'flakidock_gpt_4_sv11': 'FlakiDock-GPT4',
    'flakidock_upgrade_response_deal_DeepSeek-V3': 'FlakiDock-DS-V3'
}
# Reference tool to define the comparable run set (must be in SELECTED_TOOLS)
COMPARE_TOOL = 'one_dir_one_file_DeepSeek-V3'
...
def _discover_tool_run_logs() -> dict[str, list[str]]:
    ...
    Tool name is inferred from enclosing directory name like fixed_docker_builds_<TOOL>/run_logs.
    """
    ...
    def try_add(root: str):
        ...
        for dirpath, dirnames, _ in os.walk(root):
            ...
            if base == "run_logs":
                ...
                if parent.startswith("fixed_docker_builds_"):
                    tool_name = parent.replace("fixed_docker_builds_", "")
